  ...
  >
    <defs>
      ...
      <linearGradient id="goldFill" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#FFF2B2" /> {/* bright shine */}
        <stop offset="30%" stopColor="#FFD700" /> {/* gold */}
        <stop offset="60%" stopColor="#E6A400" /> {/* deeper gold */}
        <stop offset="100%" stopColor="#C89100" /> {/* rich gold */}
      </linearGradient>
...
export const TrophySimple = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const Zap = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M13 2L4.5 12.5h6l-1.5 8.5 9.5-11h-6L13 2z" />
  </svg>
);
...
export const EventIcon = ({ className }) => (
  ...
  >
    ...
    <path d="M12 12.8l.9 1.9 2.1.3-1.5 1.5.4 2.1-1.9-1-1.9 1 .4-2.1-1.5-1.5 2.1-.3z" />
  </svg>
);

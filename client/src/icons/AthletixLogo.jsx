    ...
    return (
        ...
        >
            <defs>
                ...
                <linearGradient id="logoPurpleAccent" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <filter id="logoInnerShine" x="-20%" y="-20%" width="140%" height="140%">
    ...
    >
        <defs>
            ...
            <filter id="iconGlow" x="-50%" y="-50%" width="200%" height="200%">
                <feDropShadow dx="0" dy="1" stdDeviation="1.5" floodColor="#FFD700" floodOpacity="0.5" />
            </filter>
        </defs>
        ...
        <rect x="14" y="23" width="4" height="3" fill="url(#iconGoldPremium)" rx="0.5" />
        <rect x="11" y="26" width="10" height="2.5" fill="url(#iconGoldPremium)" rx="1" />

...
import {
  ...
  SendIcon,
  WinnerMedalIcon,
} from "../../../icons/Portal/Manager/EventResultsIcons";

/* -------------------- Icons -------------------- */
const ICONS = {
  trophy: <TrophyIcon className="w-6 h-6 fill-current" />,
  medal: <MedalIcon className="w-6 h-6 fill-current" />,
  position: <PositionIcon className="w-5 h-5 fill-current" />,
  ...
  medal1: <WinnerMedalIcon className="w-8 h-8 fill-current" />,
  medal2: <WinnerMedalIcon className="w-8 h-8 fill-current" />,
  medal3: <WinnerMedalIcon className="w-8 h-8 fill-current" />,
};

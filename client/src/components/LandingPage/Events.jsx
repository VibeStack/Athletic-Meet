...
const Events = ({ darkMode }) => {
    ...
    const EventCard = ({ event }) => (
        <div
            className={`group relative p-6 rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 hover:-translate-y-2 hover:shadow-xl ${darkMode
    ...
    return (
        <section
            id="events"
            className={`py-16 sm:py-20 md:py-24 overflow-hidden ${darkMode ? "bg-gray-900" : "bg-linear-to-b from-gray-50 to-white"
                }`}
        >
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-14">
                    <span
                        className={`inline-block px-5 py-2 rounded-full font-semibold text-sm mb-6 ${darkMode
                    ...
                    >
                        The best competitions of Athletix 2025 — curated for champions
                    </p>
                </div>

                {/* 🏆 Signature Events - Warm Amber Background */}
                <div
                    className={`mb-10 p-6 rounded-2xl ${darkMode
                ...
                <div className="text-center pt-4">
                    ...
                    <p
                        className={`text-sm mb-6 ${darkMode ? "text-gray-500" : "text-gray-500"
                            }`}
                    >
